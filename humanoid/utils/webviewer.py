...
class WebViewer:
    def __init__(self, host: str = "127.0.0.1", port: int = 5000, record=False, output_video_file: str = 'output.mp4') -> None:
        """
    ...
    def _route_index(self) -> 'flask.Response':
        ...
        """
        with open(os.path.join(LEGGED_GYM_ROOT_DIR, "humanoid", "utils", "webviewer.html"), 'r', encoding='utf-8') as file:
            template = file.read()
